...
public class MybatisReflectionKit {
    ...
    /*public static String getMethodCapitalize(Field field, final String str) {
        ...
        // fix #176
        return MybatisStringUtils.concatCapitalize(boolean.class.equals(fieldType) ? "is" : "get", str);
    }*/
    ...
    /*public static Object getMethodValue(Class<?> cls, Object entity, String str) {
        ...
        try {
            ...
            throw new MybatisException(String.format("Error: NoSuchMethod in %s.  Cause:", cls.getSimpleName()) + e);
        } catch (IllegalAccessException e) {
            throw new MybatisException(String.format("Error: Cannot execute a private method. in %s.  Cause:",
                    cls.getSimpleName())
                    + e);
        } catch (InvocationTargetException e) {
            throw new MybatisException("Error: InvocationTargetException on getMethodValue.  Cause:" + e);
        }
    }*/
