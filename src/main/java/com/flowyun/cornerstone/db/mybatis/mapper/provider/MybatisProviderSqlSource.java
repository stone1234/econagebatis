...
import com.flowyun.cornerstone.db.mybatis.util.MybatisMapUtils;
...
import static com.flowyun.cornerstone.db.mybatis.mapper.MapperConst.RUNTIME_TABLE_NAME;
...
public class MybatisProviderSqlSource implements SqlSource {
  ...
  private SqlSource createSqlSource(
    ...
    try {
      ...
      /*
      * todo
      *  传入的参数对象是个map，可能的场景有，方法有多个参数，方法传入了集合、列表、数组
      * */
