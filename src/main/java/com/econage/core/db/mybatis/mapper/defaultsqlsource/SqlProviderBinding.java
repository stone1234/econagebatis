...
public class SqlProviderBinding {
    ...
    /*public static String parseCollectionParameterMapping(String collectionItem,Collection<?> collectionTypeParameter){
        Preconditions.checkNotNull(collectionItem,"collectionItem is null!");
        CollectionUtils.isEmpty(collectionTypeParameter);
    }*/
}
